...
call java -cp %DK_WIN%\tools\saxon\HE9-7-0-20J\saxon9he.jar net.sf.saxon.Transform -xmlversion:1.0 -s:"%XINCLUDE_FILE%" -xsl:stylesheets\ArticleAdaptations.xsl -o:"%TMP_FILE%" img.src.path="file:///%INPUT_DIR:\=/%" --suppressXsltNamespaceCheck:on
set EXIT_CODE=%ERRORLEVEL%
if not "%EXIT_CODE%" == "0" goto :SKIP_CMDS
