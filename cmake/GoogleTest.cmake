...
if(NOT TARGET gmock)
    ...
    add_subdirectory(${POPULUSROOT}/3rdparty/gmock ${CMAKE_BINARY_DIR}/gmock)
...
function(GUNITTEST_SKELETON)
    ...
    set_target_properties(${GUNITTEST_NAME} PROPERTIES COMPILE_DEFINITIONS ROOT_PATH=\"${POPULUSROOT}\")
