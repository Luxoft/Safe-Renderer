...
# PopulusEngine releases used to be built with -O3 (CMAKE_BUILD_TYPE:Release)
...
set(CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO} -O3 -DNDEBUG" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -O3 -DNDEBUG" CACHE STRING "" FORCE)

# Luxoft Populus Linux targets commons
...
if(NOT DEFINED SYSTEM_LINK_LIBS)
    set(SYSTEM_LINK_LIBS rt)
endif()
