...
PSCError ODIComSession::handleIncomingData(U32 msTimeout)
{
    if (m_connectionsList.size() > 0)
    {
        ...
        {
            const U32 timestampExceed = (m_timeout != 0) ? ( m_timeout + pgwGetMonotonicTime() ) : 0u;
...
PSCError ODIComSession::registerMsgReceiver(IMsgReceiver* pMsgReceiver, const U8 messageType, U32 minPayload, U32 maxPayload)
{
...
PSCError ODIComSession::unregisterMsgReceiver(IMsgReceiver* pMsgReceiver, U8 messageType)
{
