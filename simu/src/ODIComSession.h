...
public:
    ...
    // IMsgDispatcher
    PSCError registerMsgReceiver(IMsgReceiver* pMsgReceiver, const U8 messageType,
        U32 minPayload = IMsgDispatcher::NO_PAYLOAD_LIMIT, U32 maxPayload = IMsgDispatcher::NO_PAYLOAD_LIMIT) P_OVERRIDE;
    PSCError unregisterMsgReceiver(IMsgReceiver* pMsgReceiver, U8 messageType) P_OVERRIDE;
    ...
    PSCError handleIncomingData( U32 msTimeout) P_OVERRIDE;
