#ifndef POPULUSSC_FRAMEHANDLERCORRUPTER_H
#define POPULUSSC_FRAMEHANDLERCORRUPTER_H
...
{
public:
    FrameHandlerCorrupter(psc::FrameHandler& fh)
...
#endif // POPULUSSC_FRAMEHANDLERCORRUPTER_H
