...
void DdhReferenceBitmapFieldBuilder::addArea(const psc::AreaType& area)
{
...
void DdhReferenceBitmapFieldBuilder::addDynamicBitmap(const psc::DynamicDataType& bitmapId)
{
    ExpressionTermTypeFactory bitmapExpr;
