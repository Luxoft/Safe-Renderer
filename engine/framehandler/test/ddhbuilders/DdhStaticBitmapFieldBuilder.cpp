...
void DdhStaticBitmapFieldBuilder::create(const psc::AreaType& area,
...
void DdhStaticBitmapFieldBuilder::createWithoutVisibility(const psc::AreaType& area,
                                                          const U32 bitmapId)
{
    addArea(area);
    addBitmap(bitmapId);
...
void DdhStaticBitmapFieldBuilder::createWithoutBitmap(const psc::AreaType& area,
                                                      const bool isVisible)
{
    addArea(area);
    addVisibility(isVisible);
...
void DdhStaticBitmapFieldBuilder::addArea(const psc::AreaType& area)
{
...
void DdhStaticBitmapFieldBuilder::addDynamicBitmap(const psc::DynamicDataType& bitmapId)
{
    ExpressionTermTypeFactory bitmapExpr;
