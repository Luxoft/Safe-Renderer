#ifndef POPULUSIMAGETYPES_H
#define POPULUSIMAGETYPES_H

/******************************************************************************
**
**   File:        PopulusImageTypes.h
**   Description:
**
...
{
    /**
    * Populus image uses a layout optimized to be read and displayed by the Populus Engine.
    * Image layout:
    *
    *  ImgHeader
    *  FrameHeader, frame 1
...
#pragma pack(1)
    ...
    */
    ...
    /**
    * GUID for a Populus Image
    */
    const PopulusImageTypes::GUID simpleGuid = {0xa09f2aa6, 0xf5c0, 0x45df, {0xb3, 0xed, 0x59, 0xc7, 0x47, 0x9d, 0x57, 0xbc}};

    /**
    * GUID for a placeholder image
    */
    const PopulusImageTypes::GUID placeholderGuid = {0xa173ca0d, 0x14cb, 0x4dbd, {0x84, 0x88, 0x6a, 0xf4, 0xc4, 0x3e, 0x6b, 0x54}};

    /**
    * GUID for an atlas placeholder image
    */
    const PopulusImageTypes::GUID atlasPlaceholderGuid = {0x2e08c646, 0x1e8e, 0x46dc, {0x8e, 0xf1, 0x99, 0xa9, 0xb5, 0x28, 0xa6, 0xc1}};
    ...
    */
    ...
    {
        PopulusImageTypes::GUID guid; ///< GUID
