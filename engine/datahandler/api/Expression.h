#ifndef POPULUSSC_EXPRESSION_H
#define POPULUSSC_EXPRESSION_H
 ...
 *
 * Expressions are configured by @c psc::ExpressionTermType objects,
 ...
 *
 * @reqid SW_ENG_051, SW_ENG_049, SW_ENG_053
 */
...
public:
     ...
     * @return status of @c value, see @c DataStatus.
     */
    static DataStatus getNumber(const psc::ExpressionTermType* pTerm,
                                DataContext* pContext,
                                Number& value);
...
protected:
     ...
     */
    static void subscribe(const psc::ExpressionTermType* pTerm,
                          DataContext* pContext,
     ...
     * @param[in] pListener the listener which shall be called for data changes.
     */
    static void unsubscribe(const psc::ExpressionTermType* pTerm,
                            DataContext* pContext,
                            IDataHandler::IListener* pListener);
...
private:
     ...
     *
     * @param[in]  pExpression pointer to @c psc::ExpressionType object.
     ...
     * @return status of @c value, see @c DataStatus.
     */
    static DataStatus calcNumber(const psc::ExpressionType* pExpression,
                                 DataContext* pContext,
                                 Number& value);
};
