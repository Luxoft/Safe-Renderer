#ifndef POPULUSSC_IDATAHANDLER_H
#define POPULUSSC_IDATAHANDLER_H
...
public:
    ...
    /**
     * Registers subscription for data entry identified by @c psc::DynamicDataType.
     *
...
#endif // POPULUSSC_IDATAHANDLER_H
