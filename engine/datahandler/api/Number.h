#ifndef POPULUSSC_NUMBER_H
#define POPULUSSC_NUMBER_H
...
public:
     ...
     * - type will be equal to @c psc::DATATYPE_UNKNOWN.
     */
    Number();
     ...
     * - type will be equal to @c psc::DATATYPE_BOOLEAN.
     */
     ...
     *
     * @return the value type. See @c psc::DynamicDataTypeEnumeration.
     */
