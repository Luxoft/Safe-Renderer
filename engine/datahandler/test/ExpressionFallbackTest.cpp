...
TEST_F(ExpressionFallbackTest, FallbackReturnValidValueTest)
{
    ...
    exprFactory.createExpr(psc::EXPRESSION_OPERATOR_FALLBACK, 2U);
    ...
    const psc::Number expectedValue(10U, psc::DATATYPE_INTEGER);
...
{
    ExpressionTypeFactory exprFactory;
    exprFactory.createExpr(psc::EXPRESSION_OPERATOR_FALLBACK2, 3U);
...
TEST_F(ExpressionFallbackTest, Fallback2ReturnNotAvailableValueTest)
{
    ...
    const psc::Number expectedValue(7U, psc::DATATYPE_INTEGER);
    psc::Number actualValue;
    psc::DataStatus actualStatus =
        psc::Expression::getNumber(m_termFactory.getDdh(),
                                           &m_context,
...
{
    ExpressionTypeFactory exprFactory;
    exprFactory.createExpr(psc::EXPRESSION_OPERATOR_FALLBACK3, 4U);
...
TEST_F(ExpressionFallbackTest, Fallback3ReturnInconsistentValueTest)
{
    ...
    const psc::Number expectedValue(9U, psc::DATATYPE_INTEGER);
    psc::Number actualValue;
    psc::DataStatus actualStatus =
        psc::Expression::getNumber(m_termFactory.getDdh(),
                                           &m_context,
