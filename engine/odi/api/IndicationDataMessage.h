#ifndef POPULUSSC_INDICATIONDATAMESSAGE_H
#define POPULUSSC_INDICATIONDATAMESSAGE_H
...
public:
    ...
    bool getIndication(IndicationId indicationId) const;
...
#endif // POPULUSSC_INDICATIONDATAMESSAGE_H
