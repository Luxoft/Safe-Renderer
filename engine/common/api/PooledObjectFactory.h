#ifndef POPULUSSC_POOLEDOBJECTFACTORY_H
#define POPULUSSC_POOLEDOBJECTFACTORY_H
...
public:
     ...
     *                   If this value is equal to @c PSC_NO_ERROR, operation
     ...
     */
    inline T* createObject(PSCError& error)
    {
        T* res = NULL;
    ...
    inline T* createObject(PSCError& error, TArg1 arg1)
    {
        T* res = NULL;
        void* ptr = m_pool.allocate(error);
        if (NULL != ptr)
    ...
    inline T* createObject(PSCError& error, TArg1 arg1, TArg2 arg2)
    {
        T* res = NULL;
        void* ptr = m_pool.allocate(error);
        if (NULL != ptr)
    ...
    inline T* createObject(PSCError& error, TArg1 arg1, TArg2 arg2, TArg3 arg3)
    {
        T* res = NULL;
        void* ptr = m_pool.allocate(error);
        if (NULL != ptr)
    ...
    inline T* createObject(PSCError& error, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4)
    {
        T* res = NULL;
        void* ptr = m_pool.allocate(error);
        if (NULL != ptr)
    ...
    inline T* createObject(PSCError& error, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5)
    {
        T* res = NULL;
        void* ptr = m_pool.allocate(error);
        if (NULL != ptr)
    ...
    inline T* createObject(PSCError& error, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, TArg6 arg6)
    {
        T* res = NULL;
        void* ptr = m_pool.allocate(error);
        if (NULL != ptr)
     ...
     *
     * @return @c PSC_NO_ERROR if object deletion was successful, and other values of
     *         @c PSCError in other cases.
     */
    PSCError deleteObject(T* instance)
    {
...
#endif // POPULUSSC_POOLEDOBJECTFACTORY_H
